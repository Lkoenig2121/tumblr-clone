...
export default function Dashboard() {
  ...
  const trendingTags = [
    { rank: 1, name: 'dan and phil', subtitle: 'amazingphil', color: 'bg-gradient-to-br from-yellow-600 to-yellow-700' },
    { rank: 2, name: 'my chemical romance', subtitle: 'mcr', color: 'bg-gradient-to-br from-orange-600 to-orange-700' },
    { rank: 3, name: 'star wars', subtitle: 'star wars rebels', color: 'bg-gradient-to-br from-red-700 to-red-900' },
    { rank: 4, name: 'wicked for good', subtitle: 'glinda upland', color: 'bg-gradient-to-br from-purple-600 to-purple-800' },
  ];
  ...
  const trendingPosts = [
    {
      ...
      type: 'text',
      username: 'boag',
      content: 'Why does everyone think fiction is just fantasy wish fulfillment now and not like an exploration of themes and ideas',
...
SY: It's just a little guy that needs to pay its employees :(`,
      tags: ['bruh it literally got you Tortured but ok', 'svsss', 'scum villain', 'new extras', 'shen yuan', 'luo binghe'],
      notes: 6,
      reblogs: 100,
      likes: 468,
    },
    {
      ...
      content: 'The way social media has changed how we communicate is fascinating. We\'ve created entirely new forms of expression.',
    ...
    },
    {
      ...
      content: 'creatures creatures! i was looking for a creature to draw and ended up with several little guys',
  ...
  const staffPicks = [
    {
      ...
      content: 'The intersection of technology and art creates something truly magical. When code becomes poetry and pixels become paint.',
    ...
    },
    {
      ...
      content: 'We are not just observers of the universe, but participants in its ongoing creation. Every thought, every action, every moment shapes reality.',
    ...
    },
    {
      ...
      content: 'Found this beautiful sunset today. Sometimes the best moments are the ones we stumble upon by accident.',
  ...
  // More tab - mix of different content
  const morePosts = [
    {
      id: 'm1',
      type: 'text',
      username: 'random-thoughts',
      content: 'You know what\'s wild? The fact that we\'re all just floating on a rock in space, worrying about what to have for dinner.',
    ...
    },
    {
      ...
      type: 'text',
      username: 'bookworm',
      content: 'Just finished reading an incredible book. The way the author weaves together multiple storylines is masterful.',
    ...
    },
    {
      ...
      content: 'The future of AI is both exciting and terrifying. We\'re creating tools that could reshape everything we know.',
    ...
    },
    {
      ...
      content: 'Quick clip from my latest project!',
      videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
      tags: ['short', 'clip', 'project'],
      notes: 567,
      reblogs: 234,
      likes: 1200,
      duration: '0:45',
  ...
  return (
    <div className="min-h-screen bg-tumblr-dark">
      ...
      <div className="ml-16 md:ml-64">
        {/* Top Navigation */}
        <div className="sticky top-0 z-40 bg-tumblr-darker border-b border-gray-700">
          <div className="flex items-center justify-between px-4 md:px-6 py-4">
            <div className="flex items-center space-x-1 overflow-x-auto">
              <h1 className="text-3xl font-bold text-white mr-4 hidden md:block">t</h1>
              <button
              ...
              <button
                ...
                className="px-3 md:px-4 py-2 rounded-lg font-medium text-gray-400 hover:text-white transition flex items-center text-sm md:text-base whitespace-nowrap"
              >
                More
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden lg:block lg:w-80 xl:w-96 p-4 md:p-6 md:border-l border-gray-700">
            <div className="sticky top-24">
              <h2 className="text-white font-bold text-lg mb-4">Trending Blogs</h2>
